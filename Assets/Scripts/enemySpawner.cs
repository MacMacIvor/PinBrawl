    ...
    void spawnEnemy(int number)
    {
        switch (typeOfEnemyToSpawn)
        {
            case 0:
                ...
                enemyA.transform.position = gameObject.transform.position + new Vector3(10 * Mathf.Cos(number * (360 / number)), 0, 10 * Mathf.Sin(number * (360 / number)));
                spawned = true;
                break;
            case 1:
                ...
                enemyB.transform.position = gameObject.transform.position + new Vector3(10 * Mathf.Cos(number * (360 / number)), 0, 10 * Mathf.Sin(number * (360 / number)));
                spawned = true;
                break;
            case 2:
                ...
                enemyC.transform.position = gameObject.transform.position + new Vector3(10 * Mathf.Cos(number * (360 / number)), 0, 10 * Mathf.Sin(number * (360 / number)));
                spawned = true;
                break;
            case 3:
                ...
                enemyD.transform.position = gameObject.transform.position + new Vector3(10 * Mathf.Cos(number * (360 / number)), 0, 10 * Mathf.Sin(number * (360 / number)));
                spawned = true;
                break;
        }
    }
